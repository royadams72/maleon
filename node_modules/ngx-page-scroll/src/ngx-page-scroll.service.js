...
exports.NgxPageScrollServiceProvider = exports.PageScrollService = undefined;
...
var PageScrollService = function () {
    function PageScrollService() {
        ...
        this.onInterrupted = {
            report: function report(event, pageScrollInstance) {
                ...
                if (event.type === 'keyup') {
                    ...
                    if (_ngxPageScrollConfig.PageScrollConfig._interruptKeys.indexOf(event.keyCode) === -1) {
        ...
        if (PageScrollService.instanceCounter > 0 && (_ngxPageScrollConfig.PageScrollConfig._logLevel >= 2 || _ngxPageScrollConfig.PageScrollConfig._logLevel >= 1 && (0, _core.isDevMode)())) {
    ...
    PageScrollService.prototype.start = function (pageScrollInstance) {
        ...
        pageScrollInstance.scrollingViews.forEach(function (scrollingView) {
            if (_ngxPageScrollUtil.PageScrollUtilService.isUndefinedOrNull(scrollingView)) {
                return;
            }
        ...
        var allReadyAtDestination = Math.abs(pageScrollInstance.distanceToScroll) < _ngxPageScrollConfig.PageScrollConfig._minScrollDistance;
        // Check how long we need to scroll if a speed option is given
        // Default executionDuration is the specified duration
        pageScrollInstance.executionDuration = pageScrollInstance.duration;
        // Maybe we need to pay attention to the speed option?
        if (!_ngxPageScrollUtil.PageScrollUtilService.isUndefinedOrNull(pageScrollInstance.speed) && _ngxPageScrollUtil.PageScrollUtilService.isUndefinedOrNull(pageScrollInstance.duration)) {
        ...
        var tooShortInterval = pageScrollInstance.executionDuration <= _ngxPageScrollConfig.PageScrollConfig._interval;
        ...
        if (pageScrollInstance.interruptible || _ngxPageScrollUtil.PageScrollUtilService.isUndefinedOrNull(pageScrollInstance.interruptible) && _ngxPageScrollConfig.PageScrollConfig.defaultInterruptible) {
        ...
        }, _ngxPageScrollConfig.PageScrollConfig._interval, pageScrollInstance);
    ...
    PageScrollService.prototype.stopAll = function (namespace) {
        if (this.runningInstances.length > 0) {
            ...
            for (var i = 0; i < this.runningInstances.length; ++i) {
                ...
                if (_ngxPageScrollUtil.PageScrollUtilService.isUndefinedOrNull(namespace) || namespace.length === 0 || pageScrollInstance.namespace === namespace) {
                    stoppedSome = true;
    ...
    PageScrollService.decorators = [{ type: _core.Injectable }];
    /** @nocollapse */
...
var NgxPageScrollServiceProvider = exports.NgxPageScrollServiceProvider = {
    provide: PageScrollService,
    deps: [[new _core.Optional(), new _core.SkipSelf(), PageScrollService]],
