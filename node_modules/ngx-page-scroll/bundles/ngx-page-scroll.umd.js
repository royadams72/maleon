...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@angular/common')) : typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/router', '@angular/common'], factory) : factory((global.ngx = global.ngx || {}, global.ngx.page = global.ngx.page || {}, global.ngx.page.scroll = {}), global.ng.core, global.ng.router, global.ng.common);
})(undefined, function (exports, core, router, common) {
    'use strict';
    ...
    var PageScrollService = function () {
        function PageScrollService() {
            ...
            if (PageScrollService.instanceCounter > 0 && (PageScrollConfig._logLevel >= 2 || PageScrollConfig._logLevel >= 1 && core.isDevMode())) {
        ...
        PageScrollService.prototype.start = function (pageScrollInstance) {
            ...
            if (pageScrollInstance.interruptible || PageScrollUtilService.isUndefinedOrNull(pageScrollInstance.interruptible) && PageScrollConfig.defaultInterruptible) {
        ...
        PageScrollService.prototype.stopAll = function (namespace) {
            if (this.runningInstances.length > 0) {
                ...
                for (var i = 0; i < this.runningInstances.length; ++i) {
                    ...
                    if (PageScrollUtilService.isUndefinedOrNull(namespace) || namespace.length === 0 || pageScrollInstance.namespace === namespace) {
                        stoppedSome = true;
        ...
        PageScrollService.decorators = [{ type: core.Injectable }];
        /** @nocollapse */
    ...
    var PageScrollInstance = function () {
        ...
        PageScrollInstance.newInstance = function (options) {
            ...
            pageScrollInstance._interruptible = options.pageScrollInterruptible || PageScrollUtilService.isUndefinedOrNull(options.pageScrollInterruptible) && PageScrollConfig.defaultInterruptible;
            pageScrollInstance._advancedInlineOffsetCalculation = options.advancedInlineOffsetCalculation || PageScrollUtilService.isUndefinedOrNull(options.advancedInlineOffsetCalculation) && PageScrollConfig.defaultAdvancedInlineOffsetCalculation;
    ...
    var PageScroll = function () {
        ...
        PageScroll.decorators = [{ type: core.Directive, args: [{
                selector: '[pageScroll]',
                host: {
        ...
        PageScroll.ctorParameters = function () {
            return [{ type: PageScrollService }, { type: router.Router, decorators: [{ type: core.Optional }] }, { type: undefined, decorators: [{ type: core.Inject, args: [common.DOCUMENT] }] }];
        };
    ...
    var NgxPageScrollModule = function () {
        ...
        NgxPageScrollModule.decorators = [{ type: core.NgModule, args: [{
        ...
        /** @nocollapse */
        NgxPageScrollModule.ctorParameters = function () {
            return [];
        };
